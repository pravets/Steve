...
content = content.replace("archivesName = 'steve-ai-mod'", "archivesName = 'vasyan-ai-mod'")
...
content = read(path)
content = content.replace('steve-ai-mod-${VERSION}-all.jar', 'vasyan-ai-mod-${VERSION}-all.jar')
...
content = read(path)
content = content.replace('steve-ai-mod-1.0.0-all.jar', 'vasyan-ai-mod-1.0.0-all.jar')
content = content.replace('build/libs/steve-ai-mod-', 'build/libs/vasyan-')
content = content.replace('a Steve teleported', 'a Vasyan teleported')
